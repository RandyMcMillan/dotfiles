...
export GOAL="install"
export BITCOIN_CONFIG="-DSANITIZERS=memory -DHARDENING=OFF -DCMAKE_TOOLCHAIN_FILE=${DEPENDS_DIR}/x86_64-pc-linux-gnu/share/toolchain.cmake -DCMAKE_C_FLAGS='${MSAN_FLAGS}' -DCMAKE_CXX_FLAGS='${MSAN_AND_LIBCXX_FLAGS}'"
