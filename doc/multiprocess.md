...
[conventions](developer-notes.md#internal-interface-guidelines), like
passing serializable argument types so they can be called from different
processes, and making methods pure virtual so they can have multiple
implementations.
