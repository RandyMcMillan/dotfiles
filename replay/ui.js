 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class oe extends re{constructor(e){if(super(e),this.it=T,e.type!==ie)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===T||null==e)return this.vt=void 0,this.it=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.vt;this.it=e;const t=[e];return t.raw=t,this.vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}oe.directiveName="unsafeHTML",oe.resultType=1;const se=ae(oe);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ne extends oe{}ne.directiveName="unsafeSVG",ne.resultType=2;const le=ae(ne),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return R}});var de=__webpack_require__(9886),he=__webpack_require__(4841),pe=__webpack_require__.n(he);const fe="./w/api",ue=r(de.Z);function be(e){return[ue,e]}const me=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,ge="1.8.1";function ve(e){" "==e.key&&(e.preventDefault(),e.target.click())}class we extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    :host {
    ...
    `}render(){if(!this.svg)return U``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),U`<svg style="${ce(e)}"><g>${le(this.svg)}</g></svg>`}}customElements.define("fa-icon",we),customElements.define("wr-anim-logo",class extends we{constructor(){super(),this.svg=pe()}static get styles(){return o`
    #wrlogo #stop5687 {
    ...
    `}}),customElements.define("wr-modal",class extends X{constructor(){super(),this.title="",this.bgClass="",this.noBgClose=!1}static get properties(){return{title:{type:String},bgClass:{type:String},noBgClose:{type:Boolean}}}static get styles(){return be(o`
    .modal-background {
    ...
    </div>`}onClose(){this.dispatchEvent(new CustomEvent("modal-closed"))}});var xe,ke=__webpack_require__(8200),ye=__webpack_require__.n(ke),$e=__webpack_require__(4878),_e=__webpack_require__.n($e),Se=__webpack_require__(4124),ze=__webpack_require__.n(Se);function Ce(e,t){void 0===t&&(t={});var i=t.registrationOptions;void 0===i&&(i={}),delete t.registrationOptions;var a=function(e){for(var i=[],a=arguments.length-1;a-- >0;)i[a]=arguments[a+1];t&&t[e]&&t[e].apply(t,i)};"serviceWorker"in navigator&&xe.then((function(){Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))?(!function(e,t,i){fetch(e).then((function(a){404===a.status?(t("error",new Error("Service worker not found at "+e)),Pe()):-1===a.headers.get("content-type").indexOf("javascript")?(t("error",new Error("Expected "+e+" to have javascript content-type, but received "+a.headers.get("content-type"))),Pe()):Ie(e,t,i)})).catch((function(e){return Ae(t,e)}))}(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return Ae(a,e)}))):(Ie(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return Ae(a,e)})))}))}function Ae(e,t){navigator.onLine||e("offline"),e("error",t)}function Ie(e,t,i){navigator.serviceWorker.register(e,i).then((function(e){t("registered",e),e.waiting?t("updated",e):e.onupdatefound=function(){t("updatefound",e);var i=e.installing;i.onstatechange=function(){"installed"===i.state&&(navigator.serviceWorker.controller?t("updated",e):t("cached",e))}}})).catch((function(e){return Ae(t,e)}))}function Pe(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then((function(e){e.unregister()})).catch((function(e){return Ae(emit,e)}))}"undefined"!=typeof window&&(xe="undefined"!=typeof Promise?new Promise((function(e){return window.addEventListener("load",e)})):{then:function(e){return window.addEventListener("load",e)}});class De{constructor({name:e="sw.js",scope:t="./",appName:i="ReplayWeb.page",requireSubdomainIframe:a=!1}={}){this.name=e,this.scope=t,this.appName=i,this.requireSubdomainIframe=a,this.errorMsg=null}setAppName(e){this.appName=e}register(){let e,t;const i=new Promise(((i,a)=>{e=i,t=a}));this.errorMsg=this.getSWErrorMsg(),this.errorMsg&&(console.error(this.errorMsg),t(this.errorMsg));const a=e=>{console.error("Error during service worker registration:",e),this.errorMsg=this.getCrossOriginIframeMsg(),this.errorMsg||(this.errorMsg=`${this.appName} could not be loaded due to the following error:\n${e.toString()}`),t(this.errorMsg)};return Ce(this.scope+this.name,{registrationOptions:{scope:this.scope},registered(){console.log("Service worker is registered"),e()},error(e){a(e)}}),i}getCrossOriginIframeMsg(){return this.isCrossOriginIframe()?`      Sorry, Service Workers can not be used in cross-origin iframes.\n      This web archive embed is loaded from ${window.location.origin} but the top page is on a different origin.\n      The embed must be loaded from the same origin or a subdomain.`:null}isCrossOriginIframe(){if(window.parent===window)return!1;try{return""===window.top.location.href}catch(e){return!0}}getSWErrorMsg(){if(navigator.serviceWorker)return this.requireSubdomainIframe&&!this.isCrossOriginIframe()?`Sorry, due to security settings, this ${this.appName} embed only be viewed within a subdomain iframe.`:null;const e=this.getCrossOriginIframeMsg();return e||(window.isSecureContext?"MozAppearance"in document.documentElement.style?"Sorry, Service Workers are disabled in Firefox in Private Mode. Please try loading this page in regular mode instead.":`Sorry, ${this.appName} won't work in this browser as Service Workers are not supported in this window.\n  Please try a different browser.`:`\n      Sorry, the ${this.appName} system must be loaded from an HTTPS URL (or localhost), but was loaded from: ${window.location.host}.\n      Please try loading this page from an HTTPS URL`)}renderErrorReport(e,t){const i=this.errorMsg||t;return i?U`
    ...
    `}get mainLogo(){return pe()}renderNavBrand(){return U`
        ...
        <div class="navbar-start">
          ${me?U`
            ...
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${ve}">
              <fa-icon size="1.0rem" .svg="${ze()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?U``:U`
    ...
    <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return U`
      ...
      <fa-icon .svg="${ye()}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
    </a>
    <!--
    ...
    </wr-coll-index>`}render(){return this.inited?this.embed&&this.swErrorMsg?this.swErrorMsg:U`
  ...
  `)}render(){return U`
    ...
    `}renderCollInfo(e){return U`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return U`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Ge extends X{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return be(Ge.compStyles)}static get compStyles(){return o`
    .columns {
      width: 100%;
    }
    .column {
  ...
  <div class="column is-2"><p class="minihead">Total Size</p>${Te()(Number(e.size||0))}</div>
  `}renderSummaryView(){const e=this.coll;return U`
    <div class="columns">
      ...
      ${this.renderSource(e)}
    </div>`}renderDetailed(){const e=this.coll;let{numValid:t,numInvalid:i,domain:a,certFingerprint:r,datapackageHash:o,software:s}=this.coll.verify||{};t=t||0,i=i||0;const n=r?`https://crt.sh/?q=${r}`:"";return U`
      <div class="columns">
        <div class="column col-title is-4">
          <span class="subtitle has-text-weight-bold">
            ${e.title||e.filename}
        ...
        <div class="column">
          ...
          <p>${a}</p>
          ${n?U`<span><a target="_blank" href="${n}">View Certificate</a></span>`:""}
        </div>
        `:s?U`
        <div class="column">
        ...
        <div class="column">
          ...
          ${t>0||i>0?U`
          <p>${t} hashes verified${i?U`, ${i} invalid`:""}</p>`:U`
          Not Available`}
        </div>
      ...
      </div>`}render(){return this.detailed?this.renderDetailed():this.renderSummaryView()}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}onPurge(e){const t={reload:e};this.dispatchEvent(new CustomEvent("coll-purge",{detail:t}))}}function Ve(e){if(!e)return"";e.length<14&&(e+="00000101000000".substr(e.length));const t=e.substring(0,4)+"-"+e.substring(4,6)+"-"+e.substring(6,8)+"T"+e.substring(8,10)+":"+e.substring(10,12)+":"+e.substring(12,14)+"-00:00";return new Date(t)}function Ke(e){let t=null;try{t=new Date(e.ts||e.date)}catch(e){}const i=t&&!isNaN(t)?Ze(t.toISOString()):"";return{date:t,timestamp:i}}function Ze(e){return e.replace(/[-:T]/g,"").slice(0,14)}function Je(e,t,i){const a=new URLSearchParams;return a.set("view",e),a.set("url",t),a.set("ts",i),"#"+a.toString()}async function Ye(e){try{new URL(e)}catch(t){e=new URL(e,document.baseURI).href}const t=await async function(e,t){const i=(new TextEncoder).encode(e),a=await crypto.subtle.digest(t,i),r=Array.from(new Uint8Array(a)).map((e=>e.toString(16).padStart(2,"0"))).join("");return r}(e,"SHA-256");return{url:e,coll:"id-"+t.slice(0,12)}}customElements.define("wr-coll-info",Ge),customElements.define("wr-coll-index",We);var Qe=__webpack_require__(5056),Xe=__webpack_require__.n(Qe),et=__webpack_require__(5732),tt=__webpack_require__.n(et),it=__webpack_require__(8561),at=__webpack_require__.n(it),rt=__webpack_require__(9885),ot=__webpack_require__.n(rt),st=__webpack_require__(4636),nt=__webpack_require__.n(st),lt=__webpack_require__(1615),ct=__webpack_require__.n(lt),dt=__webpack_require__(2302),ht=__webpack_require__.n(dt),pt=__webpack_require__(6368),ft=__webpack_require__.n(pt),ut=__webpack_require__(9125),bt=__webpack_require__.n(ut),mt=__webpack_require__(9998),gt=__webpack_require__.n(mt),vt=__webpack_require__(2164),wt=__webpack_require__.n(vt),xt=__webpack_require__(426),kt=__webpack_require__.n(xt),yt=__webpack_require__(430),$t=__webpack_require__.n(yt),_t=__webpack_require__(7970),St=__webpack_require__.n(_t),zt=__webpack_require__(6144),Ct=__webpack_require__.n(zt),At=__webpack_require__(4363),It=__webpack_require__.n(At),Pt=__webpack_require__(4575),Dt=__webpack_require__.n(Pt);class Lt extends X{constructor(){super(),this.collInfo=null,this.appLogo=null,this.ts=null,this.url=null,this.active=!1}get renderRoot(){return this}static get properties(){return{collInfo:{type:Object},appLogo:{type:Object},url:{type:String},ts:{type:String},active:{type:Boolean}}}static get embedStyles(){return o`
    rwp-embed-receipt {
      display: flex;
      flex-direction: column;
    }
    ...
    .embed-globe {
      ...
      border-style: solid;
      line-height: 0.5em;
    }`}render(){let{numValid:e,numInvalid:t,domain:i,certFingerprint:a,datapackageHash:r,publicKey:o,software:s}=this.collInfo.verify||{};e=e||0,t=t||0;const n=this.collInfo.sourceUrl,l=a?`https://crt.sh/?q=${a}`:"",c=Ve(this.ts).toLocaleString();return U`
      ...
      <div class="dropdown-trigger embed-info-container">
        <button class="embed-info is-small is-rounded mt-4" aria-haspopup="true" aria-controls="embed-dropdown" @click="${this.onEmbedDrop}">
          ...
          <span class="icon is-small mr-4 ml-2">
            <fa-icon title="Toggle" .svg="${this.active?It():Ct()}" aria-hidden="true"></fa-icon>
          </span>
        </button>
      </div>
      <div class="dropdown-menu embed-info-container" id="embed-dropdown" role="menu">
        <div class="dropdown-content embed-info-drop">
          ...
          <div class="embed-info-drop-statscontainer mb-4">
            ...
            ${e>0||t>0?U`
            <p>${e} hashes verified${t?U`, ${t} invalid`:""}</p>`:U`
            <p>Not Available</p>
            `}
            <h3 class="mt-2">Package Hash:</h3>
            <p class="show-hash">${r}</p>
            <h3 class="mt-2">Size</h3>
            <p>${Te()(Number(this.collInfo.size||0))}</p>
          </div>
          ${n?U`
          <hr class="dropdown-divider">
          ...
          <a href="${n}" class="button mt-4" @keyup="${ve}">
    ...
    `}onEmbedDrop(e){e.stopPropagation(),this.active=!this.active}}customElements.define("rwp-embed-receipt",Lt);var Et="undefined"!=typeof window?window:null,Ut=null===Et,Rt=Ut?void 0:Et.document,Tt="horizontal",qt=function(){return!1},Mt=Ut?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=Rt.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",Ot=function(e){return"string"==typeof e||e instanceof String},Nt=function(e){if(Ot(e)){var t=Rt.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},Ft=function(e,t,i){var a=e[t];return void 0!==a?a:i},Bt=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},jt=function(e,t){var i=Rt.createElement("div");return i.className="gutter gutter-"+t,i},Ht=function(e,t,i){var a={};return Ot(t)?a[e]=t:a[e]=Mt+"("+t+"% - "+i+"px)",a},Wt=function(e,t){var i;return(i={})[e]=t+"px",i};const Gt=function(e,t){if(void 0===t&&(t={}),Ut)return{};var i,a,r,o,s,n,l=e;Array.from&&(l=Array.from(l));var c=Nt(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,p=Ft(t,"sizes")||l.map((function(){return 100/l.length})),f=Ft(t,"minSize",100),u=Array.isArray(f)?f:l.map((function(){return f})),b=Ft(t,"maxSize",1/0),m=Array.isArray(b)?b:l.map((function(){return b})),g=Ft(t,"expandToMin",!1),v=Ft(t,"gutterSize",10),w=Ft(t,"gutterAlign","center"),x=Ft(t,"snapOffset",30),k=Ft(t,"dragInterval",1),y=Ft(t,"direction",Tt),$=Ft(t,"cursor",y===Tt?"col-resize":"row-resize"),_=Ft(t,"gutter",jt),S=Ft(t,"elementStyle",Ht),z=Ft(t,"gutterStyle",Wt);function C(e,t,a,r){var o=S(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function A(){return n.map((function(e){return e.size}))}function I(e){return"touches"in e?e.touches[0][a]:e[a]}function P(e){var t=n[this.a],i=n[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,C(t.element,t.size,this._b,t.i),C(i.element,i.size,this._c,i.i)}function D(e){var i,a=n[this.a],r=n[this.b];this.dragging&&(i=I(e)-this.start+(this._b-this.dragOffset),k>1&&(i=Math.round(i/k)*k),i<=a.minSize+x+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+x+this._c)&&(i=this.size-(r.minSize+this._c)),i>=a.maxSize-x+this._b?i=a.maxSize+this._b:i<=this.size-(r.maxSize-x+this._c)&&(i=this.size-(r.maxSize+this._c)),P.call(this,i),Ft(t,"onDrag",qt)(A()))}function L(){var e=n[this.a].element,t=n[this.b].element,a=e.getBoundingClientRect(),s=t.getBoundingClientRect();this.size=a[i]+s[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function E(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[s];return 0===i?null:i-=y===Tt?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(u.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var s=t*r/100,n=Bt(v,0===o,o===e.length-1,w),l=u[o]+n;return s<l?(i+=l-s,a.push(0),l):(a.push(s-l),s)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var s=Math.min(i,a[r]-i);i-=s,o=e-s}return o/t*100}))}function U(){var e=this,i=n[e.a].element,a=n[e.b].element;e.dragging&&Ft(t,"onDragEnd",qt)(A()),e.dragging=!1,Et.removeEventListener("mouseup",e.stop),Et.removeEventListener("touchend",e.stop),Et.removeEventListener("touchcancel",e.stop),Et.removeEventListener("mousemove",e.move),Et.removeEventListener("touchmove",e.move),e.stop=null,e.move=null,i.removeEventListener("selectstart",qt),i.removeEventListener("dragstart",qt),a.removeEventListener("selectstart",qt),a.removeEventListener("dragstart",qt),i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",a.style.userSelect="",a.style.webkitUserSelect="",a.style.MozUserSelect="",a.style.pointerEvents="",e.gutter.style.cursor="",e.parent.style.cursor="",Rt.body.style.cursor=""}function R(e){if(!("button"in e)||0===e.button){var i=this,a=n[i.a].element,r=n[i.b].element;i.dragging||Ft(t,"onDragStart",qt)(A()),e.preventDefault(),i.dragging=!0,i.move=D.bind(i),i.stop=U.bind(i),Et.addEventListener("mouseup",i.stop),Et.addEventListener("touchend",i.stop),Et.addEventListener("touchcancel",i.stop),Et.addEventListener("mousemove",i.move),Et.addEventListener("touchmove",i.move),a.addEventListener("selectstart",qt),a.addEventListener("dragstart",qt),r.addEventListener("selectstart",qt),r.addEventListener("dragstart",qt),a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",r.style.userSelect="none",r.style.webkitUserSelect="none",r.style.MozUserSelect="none",r.style.pointerEvents="none",i.gutter.style.cursor=$,i.parent.style.cursor=$,Rt.body.style.cursor=$,L.call(i),i.dragOffset=I(e)-i.end}}y===Tt?(i="width",a="clientX",r="left",o="right",s="clientWidth"):"vertical"===y&&(i="height",a="clientY",r="top",o="bottom",s="clientHeight"),p=E(p);var T=[];function q(e){var t=e.i===T.length,i=t?T[e.i-1]:T[e.i];L.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;P.call(i,a)}return n=l.map((function(e,t){var a,r={element:Nt(e),size:p[t],minSize:u[t],maxSize:m[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:y,parent:c})._b=Bt(v,t-1==0,!1,w),a._c=Bt(v,!1,t===l.length-1,w),"row-reverse"===h||"column-reverse"===h)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var s=_(t,y,r.element);!function(e,t,a){var r=z(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(s,v,t),a._a=R.bind(a),s.addEventListener("mousedown",a._a),s.addEventListener("touchstart",a._a),c.insertBefore(s,r.element),a.gutter=s}return C(r.element,r.size,Bt(v,0===t,t===l.length-1,w),t),t>0&&T.push(a),r})),n.forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(g?q(e):e.minSize=t)})),{setSizes:function(e){var t=E(e);t.forEach((function(e,i){if(i>0){var a=T[i-1],r=n[a.a],o=n[a.b];r.size=t[i-1],o.size=e,C(r.element,r.size,a._b,r.i),C(o.element,o.size,a._c,o.i)}}))},getSizes:A,collapse:function(e){q(n[e])},destroy:function(e,t){T.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=S(i,a.a.size,a._b);Object.keys(r).forEach((function(e){n[a.a].element.style[e]="",n[a.b].element.style[e]=""}))}}))},parent:c,pairs:T}},Vt="search://";class Kt extends X{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources","info"],this.tabLabels={pages:"Pages",story:"Story",resources:"URLs",info:"Archive Info"},this.menuActive=!1,this.embedDropdownActive=!1,this.hasStory=!1,this.editable=!1,this.browsable=!0,this.clearable=!0,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl="",this.autoUpdateInterval=10,this._autoUpdater=null,this.appName="ReplayWeb.page",this.appVersion=ge,this.appLogo=pe()}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},embedDropdownActive:{type:Boolean},editable:{type:Boolean},browsable:{type:Boolean},clearable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String},appName:{type:String},appVersion:{type:String},appLogo:{type:String},autoUpdateInterval:{type:Number},swName:{type:String}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",(e=>this.onHashChange(e))),this.addEventListener("fullscreenchange",(()=>{this.isFullscreen=!!document.fullscreenElement})),this.embed&&this.loadInfo&&this.loadInfo.hideOffscreen&&(this.observer=new IntersectionObserver((e=>{this.isVisible=e[0].isIntersecting})),this.observer.observe(this))}async runUpdateLoop(){try{for(;this.editable&&this.autoUpdateInterval&&(!this.collInfo||this.collInfo.pages.length<100);)await new Promise((e=>setTimeout(e,1e3*this.autoUpdateInterval))),await this.doUpdateInfo(!0)}finally{this._autoUpdater=null}}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&this.editable&&this.autoUpdateInterval&&!this._autoUpdater&&(this._autoUpdater=this.runUpdateLoop()),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach((e=>!this.tabData[e]&&delete this.tabData[e]));const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url=Vt+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=Gt([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(e=!1){if(e&&this.tabData.url&&!this.showSidebar)return;let t=this.loadInfo&&this.loadInfo.customColl;if(!t){t=(await Ye(this.sourceUrl)).coll}this.coll=t;const i="./w/api/c/"+t,a="./w/"+t,r=await fetch(i+"?all=1");if(200!=r.status)return void(this.collInfo={});const o=await r.json();if(this.collInfo={apiPrefix:i,replayPrefix:a,coll:t,...o},this.loadInfo&&this.loadInfo.extraConfig&&this.loadInfo.extraConfig.headers){const e=this.loadInfo.extraConfig.headers;await fetch(`${i}/updateAuth`,{method:"POST",body:JSON.stringify({headers:e})})}this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"!==this.embed&&"replay-with-info"!==this.embed||(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,e.detail.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl),this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(){const e=window.location.hash;if(e&&e!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(e.slice(1)).entries()),this._locationHash=e),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.editable||this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=Ke(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.detail.reload?this.onRefresh(null,!0):e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return be(Kt.compStyles)}static get compStyles(){return o`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
    ...
    @media screen and (max-width: ${me?o`1163px`:o`1053px`}) {
      .tab-label {
        display: none;
      }
    ...
    ${Kt.replayBarStyles}`}static get replayBarStyles(){return o`
    .breadbar {
      display: flex;
      align-items: center;
      height: 35px;
    ...
    `}render(){if(!this.inited)return U``;const e=!!this.tabData.url,t=e&&this.showSidebar;if(!e&&this.tabData&&this.tabData.view){const e={title:this.tabLabels[this.tabData.view],replayTitle:!1};this.dispatchEvent(new CustomEvent("update-title",{bubbles:!0,composed:!0,detail:e}))}return this.collInfo&&!this.collInfo.coll?U`
      ...
      </nav>`}renderLocationBar(){if("replayonly"===this.embed||"replay-with-info"==this.embed)return"";const e=Ve(this.ts).toLocaleString(),t=!!this.tabData.url,i=t&&this.favIconUrl;return U`
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        <a href="#" role="button" class="button narrow is-borderless is-hidden-touch" id="fullscreen" @click="${this.onFullscreenToggle}" @keyup="${ve}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?gt():bt()}"></fa-icon>
          </span>
        </a>
    ...
    </nav><p id="skip-replay-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderVerifyInfo(){return"replay-with-info"!==this.embed?"":U`<rwp-embed-receipt
            .collInfo=${this.collInfo}
            url=${this.url}
            ts=${this.ts}
            .appLogo=${this.appLogo}
            >
            </rwp-embed-receipt>`}dragStart(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollInfo(){return U`
    <div class="info-bg">
      <wr-coll-info
      class="is-list"
      .coll="${this.collInfo}"
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?se(Li(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return U`
    ...
    `))}`}renderCPage(e){const t=new Date(e.ts),i=Ze(t.toISOString());return U`
    <li>
      <div class="content">
        <a @click="${this.onReplay}" data-url="${e.url}" data-ts="${i}"
          href="${Je("story",e.url,i)}">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return U`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return U`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?U`
              <div class="loaded-prog">Loaded <b>${Te()(this.currentSize)}</b> of <b>${Te()(this.totalSize)}</b>
              ${this.extraMsg&&U`
    ...
    <div class="main columns">
      <div class="column index-bar is-one-fifth ${this.isSidebar?"is-hidden-mobile":""}">
        ...
        ${this.editable?U`<fa-icon class="editIcon" .svg="${ji()}"></fa-icon>`:U``}

        ${this.hasExtraPages?U`
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${Te()(this.toDeletePage.size)}</b>)</p>`:U`
    ...
    </wr-modal>`:U``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=Ze(e.date):"string"==typeof e.ts&&(t=Ze(e.ts)),t===this.ts}return!1}renderPages(){return U`
        ...
        <div class="media">
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @dblclick="${this.onReload}" @click="${this.onReplay}" href="${Je("pages",this.page.url,this.page.timestamp)}">
        ...
        <div class="iframe-main modal-bg">
          <div class="panel intro-panel">
            <p class="panel-heading">
              <fa-icon id="wrlogo" size="1.5rem" .svg=${pe()} aria-hidden="true"></fa-icon>
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      ...
      ${this.sortedResults.length?this.sortedResults.map((e=>U`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${Je("resources",e.url,e.ts)}">
    ...
    `)}render(){return U`
    ${this.paramString&&this.hashString&&this.inited?U`
      <iframe sandbox="${(e=>null!=e?e:T)(this.sandbox?"allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms":void 0)}"
    ...
    ${this.errorMessage}
    `}onLoad(e){if(this.isCrossOrigin)return;const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get(this.mainElementName))return;const a=i.createElement("script");a.src=ea,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",ia)}();var aa=__webpack_require__(7589),ra=__webpack_require__.n(aa),oa=__webpack_require__(2561),sa=__webpack_require__.n(oa),na=__webpack_require__(252),la=__webpack_require__.n(na);class ca extends Kt{constructor(){super(),this._sizeUpdater=null,this.totalSize=0}static get properties(){return{...Kt.properties,totalSize:{type:Number},ipfsOpts:{type:Object}}}static get styles(){return be(ca.compStyles)}static get compStyles(){return o`
    .rec-button {
      display: flex;
      flex-direction: row;
      margin: 0 1px;
    ...
    `}updated(e){e.has("embed")&&this.embed&&!this._sizeUpdater&&(this._sizeUpdater=this.runSizeUpdater()),super.updated(e)}async runSizeUpdater(){try{for(;this.embed;){if(this.coll){const e=await fetch(`./w/api/c/${this.coll}`),t=await e.json();this.totalSize=t.size||0}await new Promise((e=>setTimeout(e,3e3)))}}finally{this._sizeUpdater=null}}renderExtraToolbar(e=!1){return this.embed?e?U`
        <a href="${fe}/c/${this.coll}/dl?format=wacz&pages=all" role="button" class="dropdown-item" @keyup="${ve}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${tt()}"></fa-icon>
          </span>
          <span>Download Archive</span>
        ...
        <span class="rec-button" title="Recording">
          <span class="icon is-small" title="Recording">
            <fa-icon size="1.2em" aria-hidden="true" .svg="${la()}"></fa-icon>
          </span>
          <span class="size-label">${Te()(this.totalSize)}</span>
        </span>
        `:e?"":U`
    <a href="#" role="button"
    class="${e?"dropdown-item is-hidden-tablet":"button narrow is-borderless"}"
      ...
      @click="${this.onShowStart}" @keyup="${ve}">
      <span class="icon is-small">
        <fa-icon size="1.2em" aria-hidden="true" .svg="${la()}"></fa-icon>
      </span>
    </a>`}renderCollInfo(){return U`
    <div class="info-bg">
      <wr-rec-coll-info
      class="is-list"
      .coll="${this.collInfo}"
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){if(this.embed)return;const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}customElements.define("wr-rec-coll",ca);var da=__webpack_require__(4771),ha=__webpack_require__.n(da),pa=__webpack_require__(2222),fa=__webpack_require__.n(pa),ua=__webpack_require__(5361),ba=__webpack_require__.n(ua),ma=__webpack_require__(7848),ga=__webpack_require__.n(ma);class va extends Ge{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgressSize=0,this.shareProgressTotalSize=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgressSize:{type:Number},shareProgressTotalSize:{type:Number},ipfsOpts:{type:Object}}}static get styles(){return be(va.compStyles)}static get compStyles(){return o`
    :host {
      overflow: visible;
    }
    ...
    ${Ge.compStyles}
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1))}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed;return U`
      <div class="columns">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <a href="${fe}/c/${this.coll.id}/dl?format=wacz&pages=all" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${tt()}"></fa-icon>
              </span>
            </a>
            <button @click="${this.onShowImport}" class="button is-small" title="Import Archive...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${Ue()}"></fa-icon>
              </span>
            </button>
            <button @click="${this.onShowStart}" class="button is-small" title="Start Recording...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${la()}"></fa-icon>
              </span>
            </button>
          </div>
        </div>
        ...
        ${e.loadUrl}
        <a @click="${t=>this.onCopy(t,e.loadUrl)}" class="copy"><fa-icon .svg="${Me()}"/></a>
        </div>`:""}
      </div>
      ${this.shareWarn?this.renderShareWarn():""}
      `}renderIPFSSharing(){return U`
    <div class="column">
              ...
              <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
                <div class="dropdown-content">
                  ...
                  <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                    <span class="icon is-small">
                      <fa-icon size="0.8em" .svg="${fa()}"></fa-icon>
                    </span>
                    Copy IPFS URL
                  </a>
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${Te()(this.deleteConfirm.size)}</b>)</p>
    ...
    </wr-modal>`:null}onIpfsShare(e){e.detail.pending?this.ipfsSharePending++:this.ipfsSharePending--}onDeleteColl(e){if(e.preventDefault(),e.stopPropagation(),!this.sortedColls)return;const t=Number(e.currentTarget.getAttribute("data-coll-index"));this.deleteConfirm=this.sortedColls[t]}async doDelete(){if(!this.deleteConfirm)return;this._deleting[this.deleteConfirm.sourceUrl]=!0,this.requestUpdate();const e=this.renderRoot.querySelector(`wr-rec-coll-info[data-coll="${this.deleteConfirm.id}"]`);e&&await e.doDelete(),this.deleteConfirm=null}renderEmpty(){return U`No Archives. Click "Create New" above to create a new archive and start recording!`}});var wa=__webpack_require__(6672),xa=__webpack_require__.n(wa);ia.setDefaultReplayFile("replay.html");class ka extends ia{constructor(){super(),this.replaybase="./replay/",this.replayfile="record.html",this.mainElementName="archive-web-page-app",this.appName="Embedded ArchiveWeb.page",this.embed="default",this.noWebWorker=!0,this.proxyPrefix="https://wabac-cors-proxy.webrecorder.workers.dev/proxy/",this.archivePrefix="";const e=new URL(window.location);e.hash="",this.logo=xa(),this.customConfig={prefix:this.proxyPrefix,isLive:!1,archivePrefix:this.archivePrefix,baseUrl:e.href,baseUrlHashReplay:!1,recording:!0,noPostToGet:!0},this.downloaded=null,this.source="proxy://"+this.proxyPrefix}static get properties(){return{...ia.properties,archivePrefix:{type:String},proxyPrefix:{type:String}}}updated(e){e.has("proxyPrefix")&&(this.customConfig.proxyPrefix=this.proxyPrefix),e.has("archivePrefix")&&(this.customConfig.archivePrefix=this.archivePrefix,this.customConfig.isLive=!this.archivePrefix),super.updated(e)}handleMessage(e){this.downloaded&&"object"==typeof e.data&&"downloadedBlob"===e.data.msg_type&&(this.downloaded(e.data.url),this.downloaded=null)}doDownload(){const e=this.renderRoot.querySelector("iframe");if(!e)return;const t=new Promise((e=>{this.downloaded=e}));return e.contentWindow.postMessage({msg_type:"downloadToBlob"}),t}}!async function(){customElements.define("record-web-page",ka)}();const ya="https://w3s.link/";function $a(e){const{hostname:t,protocol:i,pathname:a}=new URL(e),r=i.slice(0,-1);if(!t){const[e,...t]=a.slice(2).split("/");return{type:r,cid:e,path:"/"+t.join("/")}}return{type:r,cid:t,path:a}}async function _a(e){return Pa(e)?e:Da(e)?Ca(e):e}async function Sa(e){return new Response(e).blob()}async function*za(e){const t=await e.getReader();try{for(;;){const{done:e,value:i}=await t.read();if(e)return;yield i}}finally{t.releaseLock()}}function Ca(e){let t=e;t.next||(t=e[Symbol.asyncIterator]());const i=new TextEncoder;return new ReadableStream({async pull(e){const{value:a,done:r}=await t.next();if(r)await e.close();else{let t=a;"string"==typeof t&&(t=i.encode(t)),await e.enqueue(t)}}})}async function Aa(e){if(!e.ok){const t=await e.text(),i=e.status;throw new Error(`HTTP Error ${i}: ${t}`)}}async function Ia({url:e,file:t,fileName:i="",parameterName:a="file",fetch:r=globalThis.fetch,signal:o}){const s=new FormData,n=new Headers;La(e,n);const l=await async function(e){if(Pa(e))return await Sa(e);if(Da(e)){const t=Ca(e);return await Sa(t)}return e instanceof Blob?e:new Blob([e])}(t);i?s.append(a,l,i):s.append(a,l);const c=await r(e,{method:"POST",body:s,headers:n,signal:o});return await Aa(c),c}function Pa(e){return"function"==typeof e.getReader}function Da(e){return e[Symbol.asyncIterator]}function La(e,t){if(e.password)if(e.username){const i=`Basic ${btoa(`${unescape(e.username)}:${unescape(e.password)}`)}`;t.append("Authorization",unescape(i)),e.username="",e.password=""}else{const i=`Bearer ${e.password}`;t.append("Authorization",unescape(i)),e.password=""}}async function Ea({url:e,fetch:t=globalThis.fetch,signal:i}){const a=await t(e,{method:"HEAD",signal:i});await Aa(a);const r=a.headers.get("x-ipfs-datasize")||a.headers.get("Content-Length");return parseInt(r,10)}async function*Ua({url:e,start:t,end:i,format:a,signal:r,fetch:o=globalThis.fetch}){const s=new Headers;Number.isInteger(t)&&(Number.isInteger(i)?s.set("Range",`bytes=${t}-${i}`):s.set("Range",`bytes=${t}-`));const n=new URL(e);a&&(s.set("Accept",`application/vnd.ipld.${a}`),s.set("cache-control","no-cache"));const l=await o(n.href,{headers:s,signal:r});await Aa(l),yield*za(l.body)}async function*Ra({url:e,start:t,end:i,format:a,signal:r,gatewayURL:o=Ta()}){const s=function(e,t=Ta()){const{cid:i,path:a,type:r}=$a(e);return new URL(`/${r}/${i}${a}`,t)}(e,o);yield*Ua({url:s,start:t,end:i,format:a,signal:r})}function Ta(){if(!globalThis.location)return ya;const{pathname:e,hostname:t,protocol:i}=globalThis.location;if(e.startsWith("/ipfs/")||e.startsWith("/ipns/"))return`${i}//${t}/`;const[a,...r]=t.split(".");return 59===a.length&&r.length>=2?`${i}//${r.join(".")}/`:ya}let qa=!1;const Ma=[5001,45001,45002,45003,45004,45005],Oa="https://api.web3.storage/",Na="https://api.estuary.tech/",Fa="http://localhost:5001/",Ba="agregore",ja="daemon",Ha="daemon:preferred",Wa="web3.storage",Ga="estuary",Va="readonly",Ka=[Ha,Ba,ja,Wa,Ga,Va];class Za{get type(){return"invalid"}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){throw new Error("Not Implemented")}async getSize(e,t=null){throw new Error("Not Implemented")}async uploadCAR(e,t=null){throw new Error("Not Implemented")}async uploadFile(e,t,i=null){throw new Error("Not Implemented")}async clear(e,t=null){throw new Error("Not Implemented")}}async function Ja({daemonURL:e,web3StorageToken:t,web3StorageURL:i=Oa,estuaryToken:a,estuaryURL:r=Na,publicGatewayURL:o=Ta(),readonly:s=!0,timeout:n=1e3,fetch:l=globalThis.fetch}={}){const c=[],d=[];if(d.push(async function(e=globalThis.fetch){try{return await e("ipfs://localhost/"),!0}catch(e){return qa&&console.warn("Unable to detect Agregore",e),!1}}(l).then((e=>e&&c.push({type:Ba,fetch:l})))),d.push(async function(){const e=Ma.map((e=>`http://localhost:${e}`));try{const i=await Promise.any(e.map((e=>or(e).then((t=>{if(t)return e;throw new Error("Not found")})))));return!!i&&(rr&&!ar&&(t=i,ar=!0,globalThis.chrome.webRequest.onBeforeSendHeaders.addListener((e=>{const{requestHeaders:i}=e;for(const e of i)if("origin"===e.name.toLowerCase())return e.value=t,{requestHeaders:i};return e.requestHeaders.push({name:"Origin",value:t}),{requestHeaders:i}}),{urls:[t+"/*"]},["blocking","requestHeaders","extraHeaders"])),i)}catch{return!1}var t}().then((e=>e&&c.push({type:ja,url:e,fetch:l})))),e&&d.push(or(e,n,l).then((t=>t&&c.push({type:Ha,url:e,fetch:l})))),a){const e=r,t=a;c.push({type:Ga,url:e,authorization:t,fetch:l,publicGatewayURL:o})}if(t){const e=i,a=t;c.push({type:Wa,url:e,authorization:a,fetch:l,publicGatewayURL:o})}return s&&o&&c.push({type:Va,fetch:l,publicGatewayURL:o}),await Promise.allSettled(d),c}async function Ya({chooseOrder:e=Ka,...t}={}){const i=function(e,t=Ka){const i=e.filter((({type:e})=>t.includes(e))).sort((({type:e},{type:i})=>t.indexOf(e)-t.indexOf(i)))[0];if(!i)throw new Error("Unable to find valid type");return i}(await Ja(t),e);return async function(e){const{type:t}=e;let i=null;if(t===Ba)i=new er(e.fetch||globalThis.fetch);else if(t.startsWith(ja))i=new ir(e.url);else if(t===Wa)i=new tr(e.authorization,e.url,e.publicGatewayURL);else if(t===Ga)i=new Xa(e.authorization,e.url,e.publicGatewayURL);else{if(t!==Va)throw new TypeError(`Unknown API type: ${t}.`);i=new Qa(e.publicGatewayURL)}return i}(i)}class Qa extends Za{constructor(e=Ta()){super(),this.gatewayURL=e}get type(){return Va}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){yield*Ra({url:e,start:t,end:i,format:r,gatewayURL:this.gatewayURL,signal:a})}async getSize(e,t=null){const{cid:i,path:a,type:r}=$a(e);return Ea({url:new URL(`/${r}/${i}${a}`,this.gatewayURL),signal:t})}}class Xa extends Qa{constructor(e,t=Na,i=Ta()){super(i),this.authorization=e,this.url=t}get type(){return Ga}async uploadCAR(e,t=null){throw new Error("Not Implemented")}async uploadFile(e,t,i=null){const a=new URL("/content/add",this.url);a.password=this.authorization;const r=await Ia({url:a,file:e,fileName:t,parameterName:"data",signal:i}),{cid:o}=await r.json();return`ipfs://${o}/`}}class er extends Za{constructor(e=globalThis.fetch){super(),this.fetch=e}get type(){return Ba}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){const{fetch:o}=this;yield*Ua({url:e,start:t,end:i,format:r,fetch:o,signal:a})}async getSize(e,t=null){const{fetch:i}=this;return Ea({url:e,fetch:i,signal:t})}async uploadCAR(e,t=null){const i=await _a(e),{fetch:a}=this,r=await a("ipfs://localhost",{method:"POST",headers:{"Content-Type":"application/vnd.ipld.car"},signal:t,body:i});await Aa(r);return(await r.text()).split("\n")}async uploadFile(e,t=null){const i=await _a(e),{fetch:a}=this,r=await a("ipfs://localhost",{method:"POST",headers:{"Content-Type":"application/octet-stream"},signal:t,body:i});return await Aa(r),r.headers.get("Location")}}class tr extends Qa{constructor(e,t=Oa,i=Ta()){super(i),this.authorization=e,this.url=t}get type(){return Wa}async uploadCAR(e,t=null){const i=new URL("/car",this.url);i.password=this.authorization;const a=await async function({url:e,fileIterator:t,signal:i}){const a=new Headers;a.set("Content-Type","application/octet-stream"),La(e,a);const r=await _a(t),o=await fetch(e,{method:"POST",signal:i,body:r,headers:a,duplex:"half"});return await Aa(o),o}({url:i,fileIterator:e,signal:t});return(await a.text()).split("\n").filter((e=>e)).map((e=>{const{cid:t}=JSON.parse(e);return`ipfs://${t}/`}))}async uploadFile(e,{fileName:t="",signal:i=null}={}){const a=new URL("/upload",this.url);a.password=this.authorization;const r=await Ia({url:a,file:e,fileName:t,signal:i}),{cid:o}=await r.json();return`ipfs://${o}/`}}class ir extends Za{constructor(e=Fa){super(),this.url=e}get type(){return ja}async*getFile(e,{start:t,end:i,signal:a=null,format:r=null}={}){const{cid:o,path:s,type:n}=$a(e),l=new URL(`/api/v0/cat?arg=/${n}/${o}${s}`,this.url);if(t&&l.searchParams.set("offset",t),i&&l.searchParams.set("length",i-(t||0)+1),r)throw new Error("Format is unsupported on Kubo Daemons for now");const c=await fetch(l,{method:"POST",signal:a});await Aa(c),yield*za(c.body)}async*getRaw(e,{signal:t=null}={}){const{cid:i,path:a,type:r}=$a(e),o=new URL(`/api/v0/block/get?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Aa(s),yield*za(s.body)}async*getCar(e,{signal:t=null}={}){const{cid:i,path:a,type:r}=$a(e),o=new URL(`/api/v0/dag/export?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Aa(s),yield*za(s.body)}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){if(r)if("raw"===r)yield*this.getRaw(e,{start:t,end:i,signal:a});else{if("car"!==r)throw new Error(`Invalid format type, must be car or 'raw', got ${r}`);yield*this.getCar(e,{start:t,end:i,signal:a})}yield*this.getFile(e,{start:t,end:i,signal:a})}async getSize(e,t=null){try{const{cid:i,path:a,type:r}=$a(e),o=`/api/v0/file/ls?arg=/${r}/${i}${a}&size=true`,s=new URL(o,this.url),n=await fetch(s,{method:"POST",signal:t});await Aa(n);const{Objects:l}=await n.json(),[{Size:c}]=Object.values(l);return c}catch(i){return qa&&console.warn(i),this._getSizeWithDag(e,t)}}async _getSizeWithDag(e,t=null){const{cid:i,path:a,type:r}=$a(e),o=new URL(`/api/v0/dag/stat?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Aa(s);const{Size:n}=await s.json();return parseInt(n,10)}async _pin(e,t=null){const{cid:i,path:a,type:r}=$a(e),o=new URL(`/api/v0/pin/add?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Aa(s)}async _unpin(e,t=null){const{cid:i,path:a,type:r}=$a(e),o=new URL(`/api/v0/pin/rm?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Aa(s)}async clear(e,t=null){return this._unpin(e,t)}async uploadCAR(e,t=null){const i=new URL("/api/v0/dag/import?allow-big-block=true&pin-roots=true",this.url),a=await Ia({url:i,file:e,signal:t});return(await a.text()).split("\n").filter((e=>e)).map((e=>{const{Root:t}=JSON.parse(e);return`ipfs://${t.Cid["/"]}/`}))}async uploadFile(e,t="",i=null){const a=new URL("/api/v0/add?pin=true&cid-version=1&inline=false&raw-leaves=true",this.url),r=e.name&&e instanceof Blob;(t||r)&&a.searchParams.set("wrap-with-directory","true");const o=await Ia({url:a,file:e,fileName:t,signal:i}),s=await o.text(),[n]=s.split("\n"),{Hash:l}=JSON.parse(n),c=`ipfs://${l}/`;return await this._pin(c,i),c}}let ar=!1;const rr=!!(globalThis&&globalThis.chrome&&globalThis.chrome.webRequest&&globalThis.chrome.webRequest.onBeforeSendHeaders&&globalThis.chrome.webRequest.onBeforeSendHeaders.addListener);async function or(e=Fa,t=1e3,i=globalThis.fetch){try{const a=new AbortController,{signal:r}=a;setTimeout((()=>a.abort()),t);const o=await i(new URL("/api/v0/version",e),{method:"POST",signal:r});return!!o.ok||!(!o.status||404===o.status)}catch(t){return qa&&console.warn("Unable to detect Kubo Daemon",t,e),!1}}function sr(e,t){return self.chrome&&self.chrome.storage?new Promise((i=>{const a={};a[e]=t,self.chrome.storage.local.set(a,(()=>i()))})):self.localStorage?Promise.resolve(localStorage.setItem(e,t)):Promise.reject()}function nr(e){return self.chrome&&self.chrome.storage?new Promise((t=>{self.chrome.storage.local.get(e,(i=>{t(i[e])}))})):self.localStorage?Promise.resolve(localStorage.getItem(e)):Promise.reject()}const lr="0.10.0",cr="https://w3s.link/ipfs/";class dr extends Le{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[],this.autorun=!1;try{const e=localStorage.getItem("ipfsOpts");this.ipfsOpts=JSON.parse(e)}catch(e){}this.ipfsOpts=this.ipfsOpts||{daemonUrl:"",message:"",useCustom:!1,gatewayUrl:cr},nr("autorunBehaviors").then((e=>this.autorun="1"===e)),window.archivewebpage&&window.archivewebpage.setDownloadCallback((e=>this.onDownloadProgress(e)))}get appName(){return"ArchiveWeb.page"}static get properties(){return{...Le.properties,showStartRecord:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String},recordUrl:{type:String},autorun:{type:Boolean},showNew:{type:String},showImport:{type:Boolean},isImportExisting:{type:Boolean},loadedCollId:{type:String},showDownloadProgress:{type:Boolean},download:{type:Object},ipfsOpts:{type:Object},showSettings:{type:Boolean}}}initRoute(){const e=new URLSearchParams(window.location.search);e.has("config")?(super.initRoute(),this.handleMessages()):(this.inited=!0,this.sourceUrl=e.get("source")||""),this.embed||this.checkIPFS()}handleMessages(){window.addEventListener("message",(async e=>{if(this.embed&&this.loadedCollId&&"object"==typeof e.data&&"downloadToBlob"===e.data.msg_type){const t=await fetch(`./w/api/c/${this.loadedCollId}/dl?format=wacz&pages=all`),i=await t.blob();e.source.postMessage({msg_type:"downloadedBlob",coll:this.loadedCollId,url:URL.createObjectURL(i)})}}))}onStartLoad(e){this.embed||(this.showImport=!1,this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail,this.isImportExisting&&this.selCollId&&(this.loadInfo.importCollId=this.selCollId))}onCollLoaded(e){if(this.loadInfo&&this.loadInfo.importCollId&&navigator.serviceWorker.controller){const e={msg_type:"reload",full:!0,name:this.loadInfo.importCollId};navigator.serviceWorker.controller.postMessage(e)}this.embed&&(this.loadedCollId=e.detail.collInfo&&e.detail.collInfo.coll),super.onCollLoaded(e),!e.detail.alreadyLoaded&&e.detail.sourceUrl&&e.detail.sourceUrl!==this.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl)}getLoadInfo(e){if(this.disableCSP(),this.loadInfo)return this.loadInfo;return{customColl:e.startsWith("local://")?e.slice("local://".length):e}}async disableCSP(){if(this.embed||!self.chrome||!self.chrome.runtime)return;const e=navigator.userAgent.match(/Chrome\/([\d]+)/);if(!e||Number(e[1])<94)return;console.log("attempt to disable CSP to ensure replay works");let t=await new Promise((e=>{chrome.tabs.getCurrent((t=>e(t.id)))}));chrome.runtime.sendMessage({msg:"disableCSP",tabId:t})}static get styles(){return be(dr.appStyles)}static get appStyles(){return be(o`
      :host {
        font-size: initial;
        overflow: auto;
      }
          ...
          <div class="message-body">
            <div class="buttons">
              ...
              <button class="button is-small no-pad-mobile" title="Start Recording..." ?disabled="${!this.colls}" @click="${this.onShowStart}">
                <span class="icon">
                  <fa-icon size="1.0em" aria-hidden="true" .svg="${la()}"></fa-icon>
                </span>
                <span class="is-hidden-mobile">Start Recording...</span>
              </button>
              <div class="rightbar">
                <div class="infomsg is-hidden-mobile">The ArchiveWeb.page ${me?"App":"Extension"} allows you to create web archives directly in your browser!</div>
                <button class="button is-small" @click="${()=>this.showSettings=!0}">
                  <fa-icon .svg=${sa()}></fa-icon>
                </button>
              </div>
            </div>
          </div>
    ...
    ${super.render()}`}renderColl(){return U`
    <wr-rec-coll 
    .editable="${!0}"
    ...
    @show-start=${this.onShowStart}
    @show-import=${this.onShowImport}
    @about-show=${()=>this.showAbout=!0}></wr-rec-coll>`}renderCollList(e=""){return U`
    <div class="dropdown-row">
      <span>${e}&nbsp;</span>
      <div class="select is-small">
        <select @change="${this.onSelectColl}">
        ${this.colls&&this.colls.map((e=>U`
          <option value="${e.id}"
    ...
    </wr-modal>`}renderNewCollModal(){return U`
    ...
    </wr-modal`}renderImportModal(){return U`
    ...
    </wr-modal`}renderDownloadModal(){return U`
    <wr-modal .noBgClose=${!0} style="--modal-width: 740px" @modal-closed="${()=>this.showDownloadProgress=!1}" title="Download Progress">
            ...
            <section class="modal-card-body">
              <div class="container">
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      <fa-icon class="logo" size="48px" .svg="${xa()}"></fa-icon>
                      <div style="font-size: smaller; margin-bottom: 1em">${this.getDeployType()} v${lr}</div>
                    </div>
      ...
      </div>`}renderSettingsModal(){return U`
    <wr-modal @modal-closed="${()=>this.showSettings=!1}" title="Settings">
      <form class="is-flex is-flex-direction-column" @submit="${this.onSaveSettings}">
        ...
        <div class="has-text-centered">
          ...
          <button class="button" type="button" @click="${()=>this.showSettings=!1}">Close</button>
        </div>
      </form>
    </wr-modal>
    `}async onNewColl(e){this.showNew="loading",e.preventDefault();const t=this.renderRoot.querySelector("#new-title").value,i=JSON.stringify({metadata:{title:t}}),a=await fetch("./w/api/c/create",{method:"POST",body:i});await a.json();const r=this.renderRoot.querySelector("wr-rec-coll-index");r&&r.loadColls(),this.showNew=null}onSelectColl(e){this.selCollId=e.currentTarget.value}async setDefaultColl(){this.selCollId||(this.selCollId=await nr("defaultCollId")),!this.selCollId&&this.colls&&this.colls.length&&(this.selCollId=this.colls[0].id),self.chrome&&self.chrome.storage&&self.chrome.storage.local&&self.localStorage&&(await sr("index:sortKey",localStorage.getItem("index:sortKey")),await sr("index:sortDesc",localStorage.getItem("index:sortDesc")))}_setCurrColl(e){if(!(e instanceof CustomEvent))return void this.setDefaultColl();const{detail:t}=e;this.selCollId=t.coll,this.colls&&this.colls.length||(this.colls=[{id:t.coll,title:t.title}])}async onShowStart(e){this._setCurrColl(e),this.recordUrl=e.detail.url||"https://example.com/",this.showStartRecord=!0}onShowImport(e){this._setCurrColl(e),this.showImport=!0,this.isImportExisting=!0}onCollsLoaded(e){this.colls=e.detail.colls,this.setDefaultColl()}async onStartRecord(e){e.preventDefault();const t=this.renderRoot.querySelector("#url").value,i=this.renderRoot.querySelector("#preview"),a=i&&i.checked;this.showStartRecord=!1;const r=this.autorun,o=this.selCollId;if(await sr("defaultCollId",o),await sr("autorunBehaviors",r?"1":"0"),self.chrome&&self.chrome.runtime)chrome.runtime.sendMessage({msg:"startNew",url:t,collId:o,autorun:r});else if(window.archivewebpage&&window.archivewebpage.record){const e=!a;window.archivewebpage.record({url:t,collId:o,startRec:e,autorun:r})}return!1}async onTitle(e){if(super.onTitle(e),this.embed&&this.loadedCollId&&e.detail.replayTitle&&e.detail.title)try{await fetch(`./w/api/c/${this.loadedCollId}/pageTitle`,{method:"POST",body:JSON.stringify(e.detail)})}catch(e){console.warn(e)}}async onSaveSettings(e){e.preventDefault(),this.showSettings=!1;const t=this.renderRoot.querySelector("#ipfsDaemonUrl"),i=this.renderRoot.querySelector("#ipfsGatewayUrl");if(!t||!i)return;const a=t.value,r=i.value;return this.ipfsOpts={daemonUrl:a,useCustom:!!a,gatewayUrl:r},await this.checkIPFS(),localStorage.setItem("ipfsOpts",JSON.stringify(this.ipfsOpts)),!1}async checkIPFS(){const e=this.ipfsOpts;if(e.useCustom&&e.daemonUrl)e.message="IPFS Access -- Custom IPFS Daemon";else if(!e.daemonUrl){const t=await Ya({web3StorageToken:""});t instanceof ir&&(e.daemonUrl=t.url),e.useCustom=!1,t instanceof tr?e.message="Sharing via remote web3.storage":e.daemonUrl?e.daemonUrl.startsWith("http://localhost:45")?e.message="Sharing via Brave IPFS node":e.daemonUrl.startsWith("http://localhost")?e.message="Sharing via local IPFS node":e.message="":e.message="IPFS Access Unknown - Sharing Not Available"}}}customElements.define("archive-web-page-app",dr)})();var __webpack_export_target__=self;for(var i in __webpack_exports__)__webpack_export_target__[i]=__webpack_exports__[i];__webpack_exports__.__esModule&&Object.defineProperty(__webpack_export_target__,"__esModule",{value:!0})})();