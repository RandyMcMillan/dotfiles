...
then
  ...
  abort "Plebnet-Playground is only supported on MacOS and Linux.\n Pull
  requests for Windows and other OSs welcome. Please add functional tests to\n
  .github/workflows to ensure non-breaking changes on MacOS & Linux."
fi
