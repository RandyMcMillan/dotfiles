...
auto CustomPassField(TypeList<LocalType>, ServerContext& server_context, Fn&& fn, Args&&... args) ->
    decltype(
    CustomPassMessage(server_context,
...
void CustomBuildField(TypeList<LocalType>,
                      ...
                      Value&& value,
                      Output&& output,
                      typename std::enable_if<std::is_same<decltype(output.init(value.size())), ::capnp::Data::Builder>::value>::type* enable_output = nullptr,
