...
interface Node $Proxy.wrap("interfaces::Node") {
    ...
    mapPort @10 (context :Proxy.Context, useUPnP :Bool) -> ();
    ...
    estimateSmartFee @33 (context :Proxy.Context, numBlocks :Int32, conservative :Bool, wantReturnedTarget :Bool) -> (returnedTarget :Int32, result :Data);
    ...
    getWalletDir @40 (context :Proxy.Context) -> (result :Text);
    listWalletDir @41 (context :Proxy.Context) -> (result :List(Text));
    getWallets @42 (context :Proxy.Context) -> (result :List(Wallet.Wallet));
    loadWallet @43 (context :Proxy.Context, name :Text) -> (error :Common.BilingualStr, warning :List(Common.BilingualStr), result :Wallet.Wallet);
    createWallet @44 (context :Proxy.Context, passphrase :Text, flags :UInt64, name :Text) -> (error :Common.BilingualStr, warning :List(Common.BilingualStr), status: Int32, result :Wallet.Wallet);
    handleInitMessage @45 (context :Proxy.Context, callback :InitMessageCallback) -> (result :Handler.Handler);
    handleMessageBox @46 (context :Proxy.Context, callback :MessageBoxCallback) -> (result :Handler.Handler);
    handleQuestion @47 (context :Proxy.Context, callback :QuestionCallback) -> (result :Handler.Handler);
    handleShowProgress @48 (context :Proxy.Context, callback :ShowNodeProgressCallback) -> (result :Handler.Handler);
    handleLoadWallet @49 (context :Proxy.Context, callback :LoadWalletCallback) -> (result :Handler.Handler);
    handleNotifyNumConnectionsChanged @50 (context :Proxy.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler.Handler);
    handleNotifyNetworkActiveChanged @51 (context :Proxy.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler.Handler);
    handleNotifyAlertChanged @52 (context :Proxy.Context, callback :NotifyAlertChangedCallback) -> (result :Handler.Handler);
    handleBannedListChanged @53 (context :Proxy.Context, callback :BannedListChangedCallback) -> (result :Handler.Handler);
    handleNotifyBlockTip @54 (context :Proxy.Context, callback :NotifyBlockTipCallback) -> (result :Handler.Handler);
    handleNotifyHeaderTip @55 (context :Proxy.Context, callback :NotifyHeaderTipCallback) -> (result :Handler.Handler);
}
