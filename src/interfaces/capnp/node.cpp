...
bool ProxyClientCustom<interfaces::capnp::messages::Node, interfaces::Node>::initSettings(std::string& error)
{
    return gArgs.InitSettings(error) & self().customInitSettings(error);
}
