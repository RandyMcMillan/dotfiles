...
public:
        ...
        std::string& err_string) override
    {
        ...
        // Chain clients only care about failures to accept the tx to the mempool. Disregard non-mempool related
        // failures. Note: this will need to be updated if BroadcastTransactions() is updated to return other
        // non-mempool failures that Chain clients do not need to know about.
