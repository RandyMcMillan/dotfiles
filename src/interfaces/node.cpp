...
public:
    ...
    {
        return MakeHandler(::uiInterface.NotifyBlockTip_connect([fn](DownloadState download_state, const CBlockIndex* block) {
            fn(download_state, block->nHeight, block->GetBlockTime(),
    ...
    {
        return MakeHandler(
            ::uiInterface.NotifyHeaderTip_connect([fn](DownloadState download_state, const CBlockIndex* block) {
                fn(download_state, block->nHeight, block->GetBlockTime(),
