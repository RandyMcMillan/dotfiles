...
interface Chain $Proxy.wrap("interfaces::Chain") {
    ...
    haveBlockOnDisk @4 (context :Proxy.Context, height :Int32) -> (result :Bool);
    getTipLocator @5 (context :Proxy.Context) -> (result :Data);
    findLocatorFork @6 (context :Proxy.Context, locator :Data) -> (result :Int32, hasResult :Bool);
    checkFinalTx @7 (context :Proxy.Context, tx :Data) -> (result :Bool);
    findBlock @8 (context :Proxy.Context, hash :Data, block :FoundBlockParam) -> (block :FoundBlockResult, result :Bool);
    findFirstBlockWithTimeAndHeight @9 (context :Proxy.Context, minTime :Int64, minHeight :Int32, block :FoundBlockParam) -> (block :FoundBlockResult, result :Bool);
    findNextBlock @10 (context :Proxy.Context, blockHash :Data, blockHeight :Int32, next :FoundBlockParam, reorg :Bool) -> (next :FoundBlockResult, result :Bool);
    ...
    hasDescendantsInMempool @18 (context :Proxy.Context, txid :Data) -> (result :Bool);
    broadcastTransaction @19 (context :Proxy.Context, tx: Data, maxTxFee :Int64, relay :Bool) -> (error: Text, result :Bool);
    getTransactionAncestry @20 (context :Proxy.Context, txid :Data) -> (ancestors :UInt64, descendants :UInt64);
    getPackageLimits @21 (context :Proxy.Context) -> (ancestors :UInt64, descendants :UInt64);
    checkChainLimits @22 (context :Proxy.Context, tx :Data) -> (result :Bool);
    estimateSmartFee @23 (context :Proxy.Context, numBlocks :Int32, conservative :Bool, wantCalc :Bool) -> (calc :FeeCalculation, result :Data);
    estimateMaxBlocks @24 (context :Proxy.Context) -> (result :UInt32);
    mempoolMinFee @25 (context :Proxy.Context) -> (result :Data);
    relayMinFee @26 (context :Proxy.Context) -> (result :Data);
    relayIncrementalFee @27 (context :Proxy.Context) -> (result :Data);
    relayDustFee @28 (context :Proxy.Context) -> (result :Data);
    havePruned @29 (context :Proxy.Context) -> (result :Bool);
    isReadyToBroadcast @30 (context :Proxy.Context) -> (result :Bool);
    isInitialBlockDownload @31 (context :Proxy.Context) -> (result :Bool);
    shutdownRequested @32 (context :Proxy.Context) -> (result :Bool);
    getAdjustedTime @33 (context :Proxy.Context) -> (result :Int64);
    initMessage @34 (context :Proxy.Context, message :Text) -> ();
    initWarning @35 (context :Proxy.Context, message :Common.BilingualStr) -> ();
    initError @36 (context :Proxy.Context, message :Common.BilingualStr) -> ();
    showProgress @37 (context :Proxy.Context, title :Text, progress :Int32, resumePossible :Bool) -> ();
    handleNotifications @38 (context :Proxy.Context, notifications :ChainNotifications) -> (result :Handler.Handler);
    waitForNotificationsIfTipChanged @39 (context :Proxy.Context, oldTip :Data) -> ();
    handleRpc @40 (context :Proxy.Context, command :RPCCommand) -> (result :Handler.Handler);
    rpcEnableDeprecated @41 (context :Proxy.Context, method :Text) -> (result :Bool);
    rpcRunLater @42 (context :Proxy.Context, name :Text, fn: RunLaterCallback, seconds: Int64) -> ();
    rpcSerializationFlags @43 (context :Proxy.Context) -> (result :Int32);
    getSetting @44 (context :Proxy.Context, name :Text) -> (result :Common.UniValue);
    getSettingsList @45 (context :Proxy.Context, name :Text) -> (result :List(Common.UniValue));
    getRwSetting @46 (context :Proxy.Context, name :Text) -> (result :Common.UniValue);
    updateRwSetting @47 (context :Proxy.Context, name :Text, value :Common.UniValue, write :Bool) -> (result :Bool);
    requestMempoolTransactions @48 (context :Proxy.Context, notifications :ChainNotifications) -> ();
}
