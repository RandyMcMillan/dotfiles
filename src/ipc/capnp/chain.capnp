...
$Proxy.include("ipc/capnp/chain.capnp.h");
...
interface Chain $Proxy.wrap("interfaces::Chain") {
    ...
    hasDescendantsInMempool @16 (context :Proxy.Context, txid :Data) -> (result :Bool);
    broadcastTransaction @17 (context :Proxy.Context, tx: Data, maxTxFee :Int64, relay :Bool) -> (error: Text, result :Bool);
    getTransactionAncestry @18 (context :Proxy.Context, txid :Data) -> (ancestors :UInt64, descendants :UInt64);
    getPackageLimits @19 (context :Proxy.Context) -> (ancestors :UInt64, descendants :UInt64);
    checkChainLimits @20 (context :Proxy.Context, tx :Data) -> (result :Bool);
    estimateSmartFee @21 (context :Proxy.Context, numBlocks :Int32, conservative :Bool, wantCalc :Bool) -> (calc :FeeCalculation, result :Data);
    estimateMaxBlocks @22 (context :Proxy.Context) -> (result :UInt32);
    mempoolMinFee @23 (context :Proxy.Context) -> (result :Data);
    relayMinFee @24 (context :Proxy.Context) -> (result :Data);
    relayIncrementalFee @25 (context :Proxy.Context) -> (result :Data);
    relayDustFee @26 (context :Proxy.Context) -> (result :Data);
    havePruned @27 (context :Proxy.Context) -> (result :Bool);
    isReadyToBroadcast @28 (context :Proxy.Context) -> (result :Bool);
    isInitialBlockDownload @29 (context :Proxy.Context) -> (result :Bool);
    shutdownRequested @30 (context :Proxy.Context) -> (result :Bool);
    getAdjustedTime @31 (context :Proxy.Context) -> (result :Int64);
    ...
    getSetting @42 (context :Proxy.Context, name :Text) -> (result :Common.UniValue);
    getSettingsList @43 (context :Proxy.Context, name :Text) -> (result :List(Common.UniValue));
    getRwSetting @44 (context :Proxy.Context, name :Text) -> (result :Common.UniValue);
    updateRwSetting @45 (context :Proxy.Context, name :Text, value :Common.UniValue, write :Bool) -> (result :Bool);
