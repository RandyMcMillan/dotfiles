...
interface Node $Proxy.wrap("interfaces::Node") {
    ...
    handleNotifyNumConnectionsChanged @45 (context :Proxy.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler.Handler);
    handleNotifyNetworkActiveChanged @46 (context :Proxy.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler.Handler);
    handleNotifyAlertChanged @47 (context :Proxy.Context, callback :NotifyAlertChangedCallback) -> (result :Handler.Handler);
    handleBannedListChanged @48 (context :Proxy.Context, callback :BannedListChangedCallback) -> (result :Handler.Handler);
    handleNotifyBlockTip @49 (context :Proxy.Context, callback :NotifyBlockTipCallback) -> (result :Handler.Handler);
    handleNotifyHeaderTip @50 (context :Proxy.Context, callback :NotifyHeaderTipCallback) -> (result :Handler.Handler);
}
...
struct NodeStats $Proxy.wrap("CNodeStats") {
    ...
    connType @25 :Text $Proxy.name("m_conn_type_string");
    stateStats @26 :NodeStateStats $Proxy.skip;
}

struct NodeStateStats $Proxy.wrap("CNodeStateStats") {
    misbehavior @0 :Int32 $Proxy.name("m_misbehavior_score");
