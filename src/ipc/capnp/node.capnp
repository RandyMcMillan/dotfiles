...
struct NodeStats $Proxy.wrap("CNodeStats") {
    ...
    pingUsec @21 :Int64 $Proxy.name("m_ping_usec");
    pingWaitUsec @22 :Int64 $Proxy.name("m_ping_wait_usec");
    minPingUsec @23 :Int64 $Proxy.name("m_min_ping_usec");
    minFeeFilter @24 :Int64 $Proxy.name("minFeeFilter");
    addrLocal @25 :Text $Proxy.name("addrLocal");
    addr @26 :Data $Proxy.name("addr");
    addrBind @27 :Data $Proxy.name("addrBind");
    network @28 :Int32 $Proxy.name("m_network");
    mappedAs @29 :UInt32 $Proxy.name("m_mapped_as");
    connType @30 :Int32 $Proxy.name("m_conn_type");
    stateStats @31 :NodeStateStats $Proxy.skip;
}
