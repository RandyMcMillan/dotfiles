...
interface Wallet $Proxy.wrap("interfaces::Wallet") {
    ...
    addDestData @19 (context :Proxy.Context, dest :TxDestination, key :Text, value :Text) -> (result :Bool);
    eraseDestData @20 (context :Proxy.Context, dest :TxDestination, key :Text) -> (result :Bool);
    getDestValues @21 (context :Proxy.Context, prefix :Text) -> (result :List(Data));
    ...
    isLegacy @59 (context :Proxy.Context) -> (result :Bool);
