...
struct UISignals {
    boost::signals2::signal<CClientUIInterface::RequestShutdownSig> RequestShutdown;
...
ADD_SIGNALS_IMPL_WRAPPER(RequestShutdown);
...
void CClientUIInterface::RequestShutdown() { return g_ui_signals.RequestShutdown(); }
