            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::ARR, "transactions", "contents of non-coinbase transactions that should be included in the next block",
                {
                    {RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_HEX, "txid", "txid (transaction hash excluding witness data) shown in byte-reversed hex"},
                        {RPCResult::Type::STR_HEX, "hash", "wtxid (transaction hash including witness data) shown in byte-reversed hex"},
