...
class ArgsTestingSetup : public BasicTestingSetup
{
protected:
...
void ArgsTestingSetup::ResetArgs(const std::string& strArg)
{
...
void ArgsTestingSetup::SetupArgs(const std::vector<std::pair<std::string, unsigned int>>& args)
{
...
BOOST_FIXTURE_TEST_SUITE(getarg_tests, ArgsTestingSetup)
