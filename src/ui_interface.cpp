...
void CClientUIInterface::NotifyBlockTip(DownloadState s, const CBlockIndex* i) { return g_ui_signals.NotifyBlockTip(s, i); }
void CClientUIInterface::NotifyHeaderTip(DownloadState s, const CBlockIndex* i) { return g_ui_signals.NotifyHeaderTip(s, i); }
