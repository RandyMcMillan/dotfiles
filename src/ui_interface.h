...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...)                                  \
    ...
    ADD_SIGNALS_DECL_WRAPPER(NotifyBlockTip, void, DownloadState, const CBlockIndex*);

    /** Best header has changed */
    ADD_SIGNALS_DECL_WRAPPER(NotifyHeaderTip, void, DownloadState, const CBlockIndex*);
