...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_log(self):
        ...
        env, default_datadir = get_temp_default_datadir(pathlib.Path(self.options.tmpdir, "test_config_file_log"))
    ...
    def test_ignored_default_conf(self):
        ...
        # Create a temporary directory that will be treated as the default data
        # directory by bitcoind.
        env, default_datadir = get_temp_default_datadir(pathlib.Path(self.options.tmpdir, "home"))
        default_datadir.mkdir(parents=True)
